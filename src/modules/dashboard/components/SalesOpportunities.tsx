  ...
  return (
    <div className="modern-card !p-10 sm:!p-16 relative overflow-hidden group">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-8 mb-12 relative z-10">
        <div>
          <h3 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight font-display">Oportunidades de Vendas</h3>
          <p className="text-base sm:text-lg text-slate-500 font-medium mt-2">Resumo de leads e propostas ativas no funil</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative z-10">
        <div className="bg-slate-50/50 p-10 rounded-[2.5rem] border border-slate-100 flex items-center justify-between group/card hover:bg-white hover:shadow-2xl hover:shadow-orange-100/50 transition-all duration-500">
          <div className="flex items-center gap-8">
            ...
            <div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3">Leads Quentes</p>
              <h4 className="text-5xl font-black text-slate-900 font-display">{hotLeads}</h4>
            </div>
          </div>
        ...
        <div className="bg-slate-50/50 p-10 rounded-[2.5rem] border border-slate-100 flex items-center justify-between group/card hover:bg-white hover:shadow-2xl hover:shadow-blue-100/50 transition-all duration-500">
          <div className="flex items-center gap-8">
            ...
            <div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3">Propostas Ativas</p>
              <h4 className="text-5xl font-black text-slate-900 font-display">{proposalsInProgress}</h4>
            </div>
          </div>
          <div className="text-right">
