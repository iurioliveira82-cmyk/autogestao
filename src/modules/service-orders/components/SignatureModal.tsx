        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            <div className="p-8 sm:p-10 border-b border-zinc-100 flex items-center justify-between">
              <div>
                <h3 className="text-2xl font-black text-zinc-900 tracking-tight font-display">Assinatura Digital</h3>
                <p className="text-xs font-bold text-zinc-400 uppercase tracking-widest mt-1">Assine no campo abaixo</p>
              </div>
            ...
            <div className="p-8 sm:p-10">
              <div className="bg-zinc-50 border-2 border-dashed border-zinc-200 rounded-[2rem] overflow-hidden">
                <SignatureCanvas 
                  ref={sigCanvas}
                  penColor="black"
                  canvasProps={{
              ...
              <div className="flex items-center justify-between mt-8">
                ...
                <div className="flex items-center gap-4">
                  <button
                    type="button"
                    onClick={onClose}
                    className="px-6 py-3 text-sm font-black text-zinc-400 uppercase tracking-widest hover:text-zinc-900 transition-all"
                  >
                    Cancelar
                  </button>
                  <button
